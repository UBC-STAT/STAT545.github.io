...
-  A full grading rubric can be found on Canvas
...
**1.2** Have one group member make a copy of the template repository, by following the steps found on the [Collaborative Project assignment on Canvas](UDPATE LINK)

```         
-   Your repository should be named "collaborative-project-team-[number]".

-   Once completed, your repository should be in our STAT545 GitHub Organization.

-   Save the link to this repository so you can access it later.
```
...
**1.4**  Everyone should create a branch with their GitHub username in the name.
...
**3.1**  Have one person make a new document in the root of your repository called `TEAMWORK.md` (on their local machines and on their own branch). 
...
## Exercise 4: Create a README [15 points]
...
**4.4** A different person should now review and approve the pull request on GitHub, leaving a brief comment. 
...
-  Include a bullet-ed list of files in your `README.md`, which shows the contents and describes of ALL folders and files in your repository. Use backtick quotations (\`like this\`) to format your file and folder names `like this`. For example:
...
-  Working on their own branch, Member A will title the plot "Analysis of mtcars"

-  Working on their own branch, Member B will title the plot "Motor Trends Data Visualization"
