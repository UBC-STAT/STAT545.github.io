...
**Every teammate should submit at least one pull request for this milestone, and have a different teammate merge the pull request after reviewing the contents of the pull request**.
...
**Note 2:** Please indicate to the TAs which Pull Requests you would like to be graded by adding “(GRADED)” to the PR name.
