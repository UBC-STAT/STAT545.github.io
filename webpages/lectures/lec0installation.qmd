...
IF YOU NEED EXTRA HELP: TAs are available in class on Imagine Day from 9am-10:30am on Tuesday September 2nd.
...
1.  Install Anaconda from <https://www.anaconda.com/download>
    ...
    -   Install the full version of Anaconda (not miniconda)
2.  Install and setup the IR Kernel
    -   Open R install the necessary packages by entering
...
Attribution By Vincenzo Coia and Jenny Bryan, with inputs from STAT 545 teaching teams.
