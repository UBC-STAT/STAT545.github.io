...
|----|----|----|
| Worksheets | 15% | Worksheets are graded by completion. For example, if you complete the worksheet with no errors, you will get 100%. If you successfully complete 13/15 questions, your score will be 13/15 for that worksheet. |
| In class iClicker | 5% | Three iClicker questions will be given on Tuesday's lectures. Correctly answer at least one question to receive full marks for that lecture. |
