...
## Create a GitHub Repository for your R Project
...
You've created a repository for your R Project - but what happens when we edit our project on our computer? Well, we need to send those changes to our GitHub repository (it's not automatic). To do so, we need to learn about Git a little bit more. 
...
![](images/commit.png){width=400 fig-align="center"}
...
![](images/repowithchanges.png){width=400 fig-align="center"}

We can also Pull from the repository using the "Pull" button on the Git pane. 
...
* `git pull`: pull changes from the remote repository (GitHub)
...
1.  Go to your GitHub profile. Eg. Mine is <https://github.com/grcetmpk>.
...
5.  Go back to your repository main page. Click on `README.md`, then click “edit this file”. Add the following information into the `README.md` file:
    ...
    -   Your program and department at UBC
...
We will go through the [Data Carpentries tutorial](https://datacarpentry.org/rr-version-control/03-git-in-rstudio/) for this together. This demonstrates how to keep and work on the project files in a *local* repository on your machine, and how to keep it in sync with a *remote* Github repository.
