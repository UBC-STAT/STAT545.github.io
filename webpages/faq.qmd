...
-   The lecture schedule and topics?
    ...
    -   [Syllabus: Part A](../webpages/syllabus/syllabusA.qmd#schedule-of-topics)

    -   [Syllabus: Part B](../webpages/syllabus/syllabusB.qmd#schedule-of-topics)

-   How much assessments are worth?

    -   [Syllabus: Part A](../webpages/syllabus/syllabusA.qmd#assessments)

    -   [Syllabus: Part B](../webpages/syllabus/syllabusB.qmd#assessments)

-   The course GitHub repository?

    -   <https://github.com/UBC-STAT/STAT545.github.io>

-   Worksheets?

    -   [Our GitHub page](https://github.com/UBC-STAT/STAT545.github.io/tree/main/content/worksheets_student)

-   A calendar of due dates?

    -   [Canvas](https://canvas.ubc.ca/calendar)

-   A summary of what's going on this week?

    -   [Our "This Week at a Glace" section on the home page!](../index.qmd)

-   Slack posting guidelines?

    -   [Syllabus](../webpages/syllabus/syllabusA.qmd#course-communications)

-   The link to join Slack?

    -   [STAT545A Canvas Homepage](https://canvas.ubc.ca/courses/169555) (enrolled students only)

-   What to do if I'm sick?

    -   [Syllabus](../webpages/syllabus/syllabusA.qmd#your-personal-health)

-   What happens if I submit an assignment late?

    -   [Syllabus](../webpages/syllabus/syllabusA.qmd#late-policies)
